...
class ClaudeCLILLMProvider(LLMProvider):
    ...
    def _probe_version(self):
        ...
        try:
            ...
            # Example output: "claude version 0.1.0"
            ...
            # but log or handle it. For now, we just set a default.
    ...
    def complete(self, system: str, user: str, **kwargs) -> str:
        ...
        try:
            ...
            if "content" not in data:
                raise ProviderError(f"Missing 'content' in JSON response from Claude CLI. Received: {stdout}")
